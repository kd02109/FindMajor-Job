...
const URL_job = "https://teachablemachine.withgoogle.com/models/YzmksgPZY/";
// const URL_job = 'https://teachablemachine.withgoogle.com/models/kbXvs541P/';
...
async function init() {
        const modelURL = URL_job + 'model.json';
        const metadataURL = URL_job + 'metadata.json';
...
async function predict() {
	...
	/*for (let i = 0; i < 4; i++) {
        ...
        var label = "<div class='major-label d-flex align-items-center'>" + labelTitle[0] + "</div>"
